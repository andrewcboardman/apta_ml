...
x_train = np.load(f'data/{folder}/train_features_stand.npy')
y_train = np.load(f'data/{folder}/train_labels.npy')
x_test = np.load(f'data/{folder}/test_features_stand.npy')
y_test = np.load(f'data/{folder}/test_labels.npy')
